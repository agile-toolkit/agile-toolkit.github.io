...
## Unreleased
- **design-system**: 29 new shared icons (chat, barrier, clapper, clock,
  ...
  kanban, spark, rocket, wrench, robot, undo) so the remaining decorative emoji across the suite have
...
- **fix**: the Dashboard's own leftover decorative glyphs — the workspace
  ...
  into all four locales — now render as SVG icons.
